...
void MainWindow::on_action_date_2_triggered()
{
    ...
    QTextCursor cursor= (ui->textEdit->textCursor());
    cursor.insertText(dstr);
    ui->textEdit->setTextCursor(cursor);
}

void MainWindow::on_action_time_2_triggered()
{
    QTime time = QTime::currentTime();
    QString tstr = QString::number(time.hour()) + ":" + QString::number(time.minute())+":"+ QString::number(time.second());
    QTextCursor cursor= (ui->textEdit->textCursor());
    cursor.insertText(tstr);
    ui->textEdit->setTextCursor(cursor);
}
